 ...
 *
 * Disassembly of dsdt.dat, Sat May 17 08:51:57 2025
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00002353 (9043)
 *     Revision         0x02
 *     Checksum         0x21
 *     OEM ID           "VBOX  "
            ...
            Device (SBRG)
            {
                ...
                Device (^LPT0)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (CRS, \_SB.PCI0.LPT0._Y01._ALN, PAL0)  // _ALN: Alignment
                        CreateWordField (CRS, \_SB.PCI0.LPT0._Y01._LEN, PLE0)  // _LEN: Length
                ...
                Device (^LPT1)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        CreateWordField (CRS, \_SB.PCI0.LPT1._Y03._ALN, PAL1)  // _ALN: Alignment
                        CreateWordField (CRS, \_SB.PCI0.LPT1._Y03._LEN, PLE1)  // _LEN: Length
    ...
    Scope (_SB)
    {
        Scope (PCI0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                RAMT = MEML /* \MEML */
                RAMR = (0xFE000000 - RAMT) /* \_SB_.PCI0._CRS.RAMT */
                If ((PMNN != Zero))
                {
